...
void main() {
  group('FacturationPageHelpers.buildAcademicOptions', () {
    test('sorts options by group displayOrder then level displayOrder', () {
      final bundles = [
        _bundle(
          ...
          groupOrder: 2,
          levels: const [
            _LevelData(id: 'l2', name: 'Level Two', order: 2),
            _LevelData(id: 'l1', name: 'Level One', order: 1),
          ],
        ),
        _bundle(
          groupId: 'g1',
          groupName: 'Cycle One',
          groupOrder: 1,
          levels: const [_LevelData(id: 'l3', name: 'Level Three', order: 1)],
        ),
      ];
