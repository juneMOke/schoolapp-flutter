...
void main() {
  group('JSON parsing resilience', () {
    test(
      'StudentDetailModel.fromJson replaces null strings with empty strings',
      () {
    ...
    test(
      'ParentSummaryModel.fromJson replaces null strings with empty strings',
      () {
    ...
    test(
      'EnrollmentSchoolDetailModel.fromJson handles null and mixed scalar types',
      () {
