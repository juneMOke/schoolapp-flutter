...
| `expense` | Dépenses de fonctionnement : registre, tableau de bord, et le **circuit de validation** (une dépense est une demande — déposée, tranchée, puis payée) | plan et état d'avancement dans `DEPENSES_PLAN.md` (partie I = V1 livrée, partie II = v2 en cours) ; lecture 100 % locale, écriture 100 % outbox ; un geste de décision = une entrée d'outbox, en séquence par dépense |
