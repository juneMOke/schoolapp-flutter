...
void registerEnrollmentFinanceOffline(GetIt getIt) {
  ...
  getIt.registerFactory<CountPendingPaymentsUseCase>(
    () => CountPendingPaymentsUseCase(getIt<FinanceOfflineRepository>()),
  );
  getIt.registerFactory<GetRecoveryPositionsUseCase>(
    () => GetRecoveryPositionsUseCase(getIt<FinanceOfflineRepository>()),
  );
