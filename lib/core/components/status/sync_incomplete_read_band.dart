...
/// moyen de le faire tout de suite : hors du battement — qui ne retire qu'au
/// bout d'un quart d'heure — le pull n'a que des déclencheurs événementiels
/// (l'ouverture de session, le retour de la radio, la reprise de
/// l'application), et une tablette en Wi-Fi permanent posée sur le même écran
/// n'en verra aucun de la journée.
///
