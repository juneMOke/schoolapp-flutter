...
class StatusColors extends ThemeExtension<StatusColors> {
  ...
  StatusColors lerp(ThemeExtension<StatusColors>? other, double t) {
    ...
    return StatusColors(
      ...
      absentJustified:
          Color.lerp(absentJustified, other.absentJustified, t) ??
          absentJustified,
      absentUnjustified:
          Color.lerp(absentUnjustified, other.absentUnjustified, t) ??
          absentUnjustified,
      ...
      pendingUpload:
          Color.lerp(pendingUpload, other.pendingUpload, t) ?? pendingUpload,
      syncConflict:
          Color.lerp(syncConflict, other.syncConflict, t) ?? syncConflict,
    );
  }
}
