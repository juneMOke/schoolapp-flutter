...
/// Client du pull delta des classes (CF2). Miroir back CB-2 — endpoint
/// `/api/v1/sync/classrooms` ✅ LIVRÉ V1.0 (2026-07-07). Testé en unitaire avec
/// Dio mocké.
@RestApi()
abstract class ClassroomSyncApi {
  ...
  /// [updatedSince] (**ISO-8601**, `null` = pull initial complet). 304 Not
  /// Modified honoré côté repository (delta minimal).
