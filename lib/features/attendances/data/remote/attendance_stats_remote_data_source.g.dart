...
part of 'attendance_stats_remote_data_source.dart';
...
class _AttendanceStatsRemoteDataSource
    implements AttendanceStatsRemoteDataSource {
  _AttendanceStatsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<AttendanceOverviewResponseModel> getAttendanceOverview(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AttendanceOverviewResponseModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AttendanceOverviewResponseModel _value;
    try {
      _value = AttendanceOverviewResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
