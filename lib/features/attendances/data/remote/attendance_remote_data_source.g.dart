...
part of 'attendance_remote_data_source.dart';
...
class _AttendanceRemoteDataSource implements AttendanceRemoteDataSource {
  ...
  Future<List<AttendanceRecordModel>> listAttendanceForClass(
    ...
    final _options = _setStreamType<List<AttendanceRecordModel>>(
    ...
    late List<AttendanceRecordModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                AttendanceRecordModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
  ...
  Future<void> recordDailyAttendance(
    Map<String, dynamic> extras,
    DailyAttendanceCommandModel command,
  ) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras);
    final queryParameters = <String, dynamic>{};
