...
/// Contexte d'une reponse de stats (annee scolaire, periode, bornes). Mappe
/// vers l'entite partagee [StatsContext]. Le champ `currency` du backend est
/// ignore ici (absent des stats de presence, sans dimension monetaire).
