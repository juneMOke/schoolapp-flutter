...
class _FinanceSyncApi implements FinanceSyncApi {
  ...
  Future<PaymentCommitAck> commitPayment(
    ...
    final _options = _setStreamType<PaymentCommitAck>(
    ...
    late PaymentCommitAck _value;
    try {
      _value = PaymentCommitAck.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<LedgerDelta> pullLedger(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LedgerDelta>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/sync/finance/ledger',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LedgerDelta _value;
    try {
      _value = LedgerDelta.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
