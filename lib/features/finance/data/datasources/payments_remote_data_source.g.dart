...
class _PaymentsRemoteDataSource implements PaymentsRemoteDataSource {
  _PaymentsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<List<PaymentModel>> listPaymentsByStudentAndAcademicYear(
    ...
    final _options = _setStreamType<List<PaymentModel>>(
  ...
  Future<PaymentModel> createPayment(
    Map<String, dynamic> extras,
    CreatePaymentRequestModel request,
  ) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras);
    final queryParameters = <String, dynamic>{};
  ...
  Future<List<PaymentAllocationsModel>> listPaymentAllocationsByPaymentId(
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<List<PaymentAllocationsModel>>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<List<dynamic>>(_options);
    late List<PaymentAllocationsModel> _value;
    try {
      _value = _result.data!
          .map(
            (dynamic i) =>
                PaymentAllocationsModel.fromJson(i as Map<String, dynamic>),
          )
          .toList();
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
