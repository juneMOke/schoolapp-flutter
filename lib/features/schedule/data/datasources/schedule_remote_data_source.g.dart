...
class _ScheduleRemoteDataSource implements ScheduleRemoteDataSource {
  ...
  Future<WeeklyTimetableModel> getMyTimetable(
    ...
    final _options = _setStreamType<WeeklyTimetableModel>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/schedule/my-timetable',
    ...
    late WeeklyTimetableModel _value;
    try {
      _value = WeeklyTimetableModel.fromJson(_result.data!);
    } on Object catch (e, s) {
  ...
  Future<TimeSlotModel> createTimeSlot(
    Map<String, dynamic> extras,
    CreateTimeSlotRequestModel request,
  ) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras);
    final queryParameters = <String, dynamic>{};
    ...
    final _options = _setStreamType<TimeSlotModel>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/schedule/time-slots',
            queryParameters: queryParameters,
            data: _data,
          )
          .copyWith(baseUrl: _combineBaseUrls(_dio.options.baseUrl, baseUrl)),
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late TimeSlotModel _value;
    try {
      _value = TimeSlotModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options, response: _result);
      rethrow;
    }
  ...
  @override
  Future<void> deleteSession(Map<String, dynamic> extras, String id) async {
    final _extra = <String, dynamic>{};
    _extra.addAll(extras);
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
