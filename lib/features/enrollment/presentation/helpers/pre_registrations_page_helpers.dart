...
class PreRegistrationsPageHelpers {
  const PreRegistrationsPageHelpers._();

  /// Aplatit les cycles/niveaux de l'année **courante** (contrairement au
  /// vivier de réinscription, borné à l'année N-1 — une pré-inscription vise
  /// un niveau de l'année en préparation) en options plates utilisables par la
  /// recherche bi-mode.
