...
/// Carte décorative réutilisée par toutes les sections du dashboard stats.
class EnrollmentStatsChartCard extends StatelessWidget {
  final String title;
  final Widget child;

  const EnrollmentStatsChartCard({
    super.key,
    required this.title,
    required this.child,
  });
