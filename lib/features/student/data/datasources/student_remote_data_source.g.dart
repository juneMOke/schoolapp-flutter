...
part of 'student_remote_data_source.dart';
...
class _StudentRemoteDataSource implements StudentRemoteDataSource {
  _StudentRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<StudentDetailModel> updateStudentPersonalInfo(
    ...
    String studentId,
    UpdateStudentPersonalInfoRequest request,
  ) async {
